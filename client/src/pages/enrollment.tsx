                            ...
                            /**
                             * PROGRAM IMAGES MAPPING – AIIA PROGRAM FLYERS (LATEST)
                             * programImages.masterAiOrgs           -> AIIA FLYERS LATES-13.jpg
                             * programImages.basicAiCert            -> AIIA FLYERS LATES-2.jpg
                             * programImages.aiDiploma              -> AIIA FLYERS LATES-5.jpg
                             * programImages.postgradAiDiploma      -> AIIA FLYERS LATES-7.jpg
                             * programImages.nonGraduateAiCert      -> AIIA FLYERS LATES-10.jpg
                             * programImages.graduateAiCert         -> AIIA FLYERS LATES-6.jpg
                             * programImages.advancedAiCert         -> AIIA FLYERS LATES-12.jpg
                             * programImages.certificationsOverview -> AIIA FLYERS LATES-16.jpg
                             */
                                ...
                                <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 overflow-hidden">
                                  ...
                                  <Dialog open={open} onOpenChange={setOpen}>
                                    <DialogContent className="sm:max-w-3xl max-h-[90vh] overflow-y-auto">
                                      ...
                                      {errorMsg && (
                                        <div className="rounded-md border border-red-300 bg-red-50 text-red-700 px-3 py-2 text-sm">{errorMsg}</div>
                                      )}
                                      {successMsg && (
                                              ...
                                              {corporateProgramOptions.map((p) => (
                                                ...
                                                >
                                                  <Checkbox
                                                    ...
                                                    onCheckedChange={() => toggleCorporateProgram(p.id)}
                                                  />
                                                  <div className="flex gap-3">
                                                    <img src={p.image} alt={p.name} className="w-24 h-16 object-contain bg-white border rounded" />
                                                    <div className="font-medium">{p.name}</div>
